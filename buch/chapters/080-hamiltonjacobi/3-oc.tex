...
\end{equation}
Daraus folgend die Hamilton-Differentialgleichungen mit Randbedingungen
\begin{align*}
\dot{x}(t)&=u(t)
&
x(0)&=x_0
...
Die Hamilton-Differentialgleichungen haben jetzt die Randbedingungen
\begin{align*}
\dot{x}(t)&=u(t)
&
x(0)&=x_0
...
Abbildung~\ref{buch:hamiltonjacobi:oc:bsp:switch:fig} dargestellt.
