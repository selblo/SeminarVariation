...
Sei jetzt $u_0(x)$ eine Lösung der Jacobi-Differentialgleichung
ohne Nullstellen im Inneren des Intervalls $[x_0,x_1]$.
Dann kann die Variation $\eta(x) = \alpha(x)u_0(x)$ geschrieben
werden.
Die Ableitung ist $\eta'(x) = \alpha'(x) u_0(x) + \alpha(x)u_0'(x)$.
