...
\frac{1}{|\vec{r} - \vec{r}\,'|}
=
\sum_{n=0}^{\infty} \frac{1}{n!} \left( \vec{r}\,' \cdot \vec{\nabla}\,' \right)^n \left. \frac{1}{|\vec{r} - \vec{r}\,'|} \right|_{\vec{r}\,'=0}
\end{equation*}
...
\begin{equation*}
\frac{1}{|\vec{r} - \vec{r}'|} = \sum_{n=0}^{\infty} \frac{1}{n!} \left( - \vec{r}\,' \cdot \vec{\nabla} \right)^n \frac{1}{r}.
\end{equation*}
...
\begin{align*}
\frac{1}{|\vec{r} - \vec{r}'|} &= \frac{1}{r} - r\,'_{i} \partial_{i} \frac{1}{r} + \frac{1}{2} r\,'_{i} r\,'_{j} \partial_{i} \partial_{j} \frac{1}{r} + \mathcal{O}(r\,'^{3}) \\
