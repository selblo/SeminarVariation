...
Damit man die Gesuchte Funktion finden kann, muss man den Gradienten des jeweiligen Funktionals berechnen und anschliessend in
\begin{equation}
	\nabla N \cdot \lambda = \nabla L
...
Die Gradienten der Funktionale sind definiert als 
\begin{equation*}
	\nabla L = 
...
\end{equation*}
Somit können wir die Gradienten in die Gleichung \ref{planet:equ:lamdagleichung} einsetzen und erhalten
\begin{equation*}
