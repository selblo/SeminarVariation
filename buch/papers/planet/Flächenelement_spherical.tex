...
%            \node[blue] at (\xnododp,\ynododp,\znododp) {$d\phi$};
            ...
            \draw[red,thick,opacity=0.7] (O) -- (\Px,\Py,\Pz);        
            \draw[red,thick,opacity=0.7] (O) -- (\Tx,\Ty,\Tz);
            \draw[red,thick,opacity=0.7] (O) -- (\Sx,\Sy,\Sz);
            \draw[red,thick,opacity=0.7] (O) -- (\Wx,\Wy,\Wz);
            \draw[red,thick,fill=red,opacity=0.3] (O) -- (\Px,\Py,\Pz) -- (\Tx,\Ty,\Tz) -- (O);
            \draw[red,thick,fill=red,opacity=0.3] (O) -- (\Tx,\Ty,\Tz) -- (\Wx,\Wy,\Wz) -- (O);
            \draw[red,thick,fill=red,opacity=0.3] (O) -- (\Wx,\Wy,\Wz) -- (\Sx,\Sy,\Sz) -- (O);
            \draw[red,thick,fill=red,opacity=0.3] (O) -- (\Sx,\Sy,\Sz) -- (\Px,\Py,\Pz) -- (O);
