...
Müssen wir also nur ein geeignetes Geschwindigkeitsfeld finden.
...
Dazu verwenden wir erneut FEM als SimulationsmethodeIn diesen Simulationen variieren wir die Stärke des Rührens,
repräsentiert durch den Parameter $\alpha$ in unserem Geschwindigkeitsfeld.
Indem wir unterschiedliche Werte für $\alpha$ wählen,
können wir den Einfluss verschiedener Rührintensitäten auf die Phasentrennung
