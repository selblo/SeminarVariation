...
% !TEX encoding = UTF-8
%
\chapter{Minimalflächen}
\kopflinks{Minimalflächen}
\begin{refsection}
	\chapterauthor{Ronja Allenfort und Ana Milivojevic}
	
	
	Unter Minimalfläche versteht man eine beliebige Fläche im Raum, mit der Spezialität, dass der Flächeninhalt jeweils dem lokalen Minimum entspricht. 
...
\input{papers/minimalflaechen/teil0.tex}
\input{papers/minimalflaechen/teil1.tex}
\input{papers/minimalflaechen/teil2.tex}
\input{papers/minimalflaechen/teil3.tex}
