...
\begin{itemize}
	...
	Das Helikoid ist wie eine Treppe, die sich nicht etnscheiden kann, ob sie geradeaus oder im Kreis gehen soll - also macht sie beides. Sie wendet sich in einer endlosen Spirale nach oben und unten.
	%
\begin{figure}
	\centering
...
\end{figure}
	...
	\end{equation}
	beschrieben.
	Die Schreksche Minimalfläche ist wie eine Serie von Wellen 
%
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"papers/minimalflaechen/Schreksche Minimalfläche"}
...
\begin{figure}
	...
	\cite{minimalflaechen:henneberg}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"papers/minimalflaechen/Stadion 1"}
	\caption{Olympiastadion München}
	\label{fig:stadion-1}
	\cite{minimalflaechen:Olympiastadion}
\end{figure}
