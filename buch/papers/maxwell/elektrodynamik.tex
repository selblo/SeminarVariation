...
\begin{align*}
\rlap{$L(\Omega^0,...,\Omega^3, A^0,...,A^3, \partial^0 A^i,...,\partial^3 A^i)$}
\qquad
\\
&=
\frac{1}{2\mu_0}\,\biggl(\left(\partial^0 A^1 + \partial^1 A^0\right)^2 + \left(\partial^0 A^2 + \partial^2 A^0\right)^2 + 
\left(\partial^0 A^3 + \partial^3 A^0\right)^2\biggr) \\
&\qquad -  \frac{1}{2\mu_0}\,\biggl(\left(\partial^2 A^3 - \partial^3 A^2\right)^2 + \left(\partial^3 A^1 - \partial^1 A^3\right)^2 + 
\left(\partial^1 A^2 - \partial^2 A^1\right)^2\biggr)\\
&\qquad + J^0 A^0 + J^1 A^1 + J^2 A^2 + J^3 A^3.
\end{align*}
...
&\Leftrightarrow& \frac{\partial ^2 \vec{B}}{\partial t^2}
&=
...
&\Leftrightarrow& \frac{\partial ^2 \vec{E}}{\partial t^2}
&=
