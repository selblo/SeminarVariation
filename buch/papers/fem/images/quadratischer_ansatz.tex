...
({\x},{(-4*(-1-\x)*(0-\x))});
\draw[color=darkred,line width=1.4pt] plot[domain=0:1.075, scale=4, smooth]
({\x},{0});
...
({\x},{(-4*(0-\x)*(1-\x))});
\draw[color=darkblue,line width=1.4pt] plot[domain=1:1.075, scale=4, smooth]
({\x},{0});

% x-Achse
\draw[->] (-4.1,0) -- (4.3,0) coordinate[label={$x$}];
\node at (-4,0) [below left]  {$-2 \Delta x$};
\draw (-4,-0.1) -- (-4,0.1);
\node at (-2,0) [below right] {$-\Delta x$};
\draw (-2,-0.1) -- (-2,0.1);
\node at ( 0,0) [below]       {$0$};
\draw ( 0,-0.1) -- ( 0,0.1);
\node at ( 2,0) [below left]  {$\Delta x$};
\draw ( 2,-0.1) -- ( 2,0.1);
\node at ( 4,0) [below right] {$2 \Delta x$};
\draw ( 4,-0.1) -- ( 4,0.1);
