...
Diese Punkte werden Elemente genannt und jeweils mit den nächstgelegenen Nachbarn verbunden und nummeriert. 
...
Zum Aufstellen der Matrizen wird, analog zum eindimensionalen Fall, jeder Eintrag mit der zugehörigen Formel ausgewertet.
Für $\mathbf{L}$ gilt
\begin{equation}
