...
Dabei wird die ursprüngliche Funktion an den Punkten $x_n = n \cdot \Delta x$ abgetastet. 
...
\begin{equation}
    a(x) = \left\{ \begin{array}{ll}
        \frac{1}{2(\Delta x)^2} \cdot x^2 + \frac{3}{2 \Delta x} + 1  
            & \text{für} \quad -2 \Delta x < x < 0 \\
        \frac{1}{2(\Delta x)^2} \cdot x^2 - \frac{3}{2 \Delta x} + 1 
            & \text{für} \quad 0 \leq x < 2 \Delta x \\
        0
            & \text{sonst}
    \end{array} \right.
\end{equation}
...
\begin{equation}
    a(x) = \left\{ \begin{array}{ll}
        -\frac{1}{(\Delta x)^2} x^2 + 1 
            & \text{für} \quad -\Delta x < x < \Delta x \\
        0 
            & \text{sonst}
    \end{array} \right.
\end{equation}
