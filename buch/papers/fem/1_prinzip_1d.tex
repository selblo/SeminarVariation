...
\end{enumerate}
% TODO: Sechs Schritte durch das Paper ziehen
...
% TODO: Bild zu den Formfunktionen / Approximation einer Fkt. durch diese. Zudem: unterschiedliche delta x
...
\begin{equation}
    a(x) = \left\{ \begin{array}{ll}
        TODO: Formel & \text{für} \quad -2 \Delta x < x < 0 \\
        TODO: Formel & \text{für} \quad 0 \leq x < 2 \Delta x \\
        0            & \text{sonst}
    \end{array} \right.
\end{equation}
für gerade $n$ und
\begin{equation}
    a(x) = \left\{ \begin{array}{ll}
        TODO: Formel & \text{für} \quad -\Delta x < x < 0 \\
        TODO: Formel & \text{für} \quad 0 \leq x < \Delta x \\
        0            & \text{sonst}
    \end{array} \right.
\end{equation}
