...
\end{equation}
Die Punktableitungen bedeuten hier, dass jetzt nach $s$ abgeleitet wird.
...
\begin{equation}
	...
	\label{geodaeten:equation:StandardverfahrenGeodaeten:equation1}
\end{equation}
...
Mithilfe von \eqref{geodaeten:equation:StandardverfahrenGeodaeten:equation1} erhalten wir für die partielle Ableitung nach $n^k$  
\begin{equation}
...
\begin{equation}
	 g_{kn} \, \ddot{u}^k + \frac{1}{2} \left( \frac{\partial g_{jn}}{\partial u^i} + \frac{\partial g_{in}}{\partial u^j} - \frac{\partial g_{ij}}{\partial u^n} \right) \, \dot{u}^i \, \dot{u}^j = 0.
\end{equation}
