...
Der Ausdruck $\varphi$ repräsentiert im Wesentlichen den quadrierten Betrag des Geschwindigkeitsvektors im gekrümmten Raum, der durch die Metrik $g_{ij}$ beschrieben wird.
Entlang der Geodätenlinie können wir eine konstante Geschwindigkeit bestimmen, da diese keinen Einfluss auf die Distanz hat.
Wir nehmen also zusätzlich an, dass $\varphi = 1$ ist.
