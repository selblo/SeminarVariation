...
Anders als im Fall des Zylinders, wo der metrische Tensor konstant war, führt die Abhängigkeit des metrischen Tensors von den Koordinaten ($\theta$) zu nicht-verschwindenden Christoffel-Symbol, die die intrinsische Krümmung der Kugeloberfläche beschreiben.
...
Die nicht-verschwindenden Christoffel-Symbol beschreiben diese Krümmung und zeigen an, wie sich die Richtung eines Vektors während des Transports entlang der Oberfläche ändert.

Mit den berechneten Christoffel-Symbol können wir nun die Geodätengleichungen für die Kugeloberfläche aufstellen.
...
Setzen wir die entsprechenden Christoffel-Symbol und Koordinaten in die Gleichungen ein, erhalten wir:
\begin{equation}
	\begin{aligned} 
	...
	\end{aligned}
\end{equation}
Da einige der Christoffel-Symbol Null sind, vereinfachen sich Geodätengleichung zu:
\begin{align}
