...
Mit diesen Ableitungen und dem inversen Tensor $g^{ij}$ können wir nun die Christoffelsymbole berechnen:
\begin{equation}
...
Da einige der Christoffelsymbole Null sind, vereinfachen sich Geodätengleichung zu:
\begin{align}
