...
die ersichtlich wird, wenn das gleiche Koordinatensystem wie bei der Abbildung \ref{antennen:koordSysBsp}
...
\end{equation}
definieren. Dazu wird die Funktion $f$ mit der Nebenbedingung $n(a_1,a_2,l)$ und einem
...
ging je nach Maschine und Anfangswerte, 5 bis 10 Minuten.}
