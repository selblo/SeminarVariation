...
\begin{figure}[htbp]
	...
	\begin{minipage}[b]{0.45\textwidth}
		...
		\begin{tikzpicture}
			...
			\draw[green, dashed, line width=0.5mm] (3.14156/4, \triangleheight/2) -- (0.75*\sidelength, \triangleheight/2);
			\draw[green, dashed, line width=0.5mm] (3.14156/4, \triangleheight/2) -- (0.5*\sidelength, 0);
			\draw[green, dashed, line width=0.5mm] (0.5*\sidelength, 0) -- (0.75*\sidelength, \triangleheight/2);
		\end{tikzpicture}
