...
\begin{figure}[htbp]
	...
	\begin{minipage}[t]{0.45\textwidth}
		...
		\begin{tikzpicture}
			...
			% Draw the flattened inner triangle
	...
	\begin{minipage}[t]{0.45\textwidth}
		...
		\begin{tikzpicture}
			...
			\draw (1pt,\y) -- (-1pt,\y) node[left] {\y};
		\end{tikzpicture}
		\caption{Antennenform mit abgerundeten Ecken}
...
\begin{figure}[htbp]
	...
	\begin{minipage}[b]{0.45\textwidth}
		...
		\begin{tikzpicture}
			...
			\draw[clrGreen, dashed, line width=0.5mm] (3.14156/4, \triangleheight/2) -- (0.75*\sidelength, \triangleheight/2);
			\draw[clrGreen, dashed, line width=0.5mm] (3.14156/4, \triangleheight/2) -- (0.5*\sidelength, 0);
			\draw[clrGreen, dashed, line width=0.5mm] (0.5*\sidelength, 0) -- (0.75*\sidelength, \triangleheight/2);
		\end{tikzpicture}
